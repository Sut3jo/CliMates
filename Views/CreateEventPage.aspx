<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Navbar.Master" AutoEventWireup="true" CodeBehind="CreateEventPage.aspx.cs" Inherits="ProjectSE.Views.CreateEventPage" %>
            ...
            <div class="form">
                <div class="center">
                    ...
                    <div class="rows">
                        ...
                        <asp:TextBox CssClass="textboxdesc" ID="TextBoxDescription" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </div>
                    <div class="rows">
                        <div class="insider-row">
                            <asp:Label CssClass="labeltext" ID="LabelReq" runat="server" Text="Event Requirements"></asp:Label><span class="required">*</span>
                        </div>
                        <asp:TextBox CssClass="textboxreq" ID="TextBoxReq" runat="server" TextMode="MultiLine" placeholder="e.g 1. Berusia minimal 18 tahun."></asp:TextBox>
                    </div>
                    ...
                    <div class="button">
                        <asp:Button ID="ButtonRequest" CssClass="buttonRequest" runat="server" Text="Create Event" OnClick="ButtonRequest_Click" />
                    </div>
                </div>
            </div>
        </div>
